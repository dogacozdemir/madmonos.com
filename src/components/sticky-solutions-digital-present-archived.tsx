/**
 * ARŞİV — Önceki “Digital Present”: sticky görseller, sağ rail, `DIGITAL_PRESENT_PROJECTS`.
 * Sayfada kullanılmıyor; geri dönmek için referans.
 * Aktif blok: `sticky-solutions.tsx` (What we do · Trinity).
 */
 ...
 */
export function StickySolutionsDigitalPresentArchived() {
